...
const About = () => (
  <section
    ...
    sm:px-12 sm:py-10 px-8 py-8 mb-[-18%]"
  >
    <div className="mb-[20%]">
      ...
      <p className="body-text text-justify md:px-24">
        ...
        tinkering, I naturally fell in love with software development during my
        undergrad at UC Irvine. I am passionate about combining creative design
